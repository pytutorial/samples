...
SELECT student_no, name, gpa FROM student WHERE gpa >= 7.0 AND address = 'Hà Nội' ORDER BY gpa;
SELECT student_no, name, gpa FROM student WHERE gpa >= 7.0 AND address = 'Hà Nội' ORDER BY gpa DESC;
